  ...
  <tr>
    <td width="50%" style="padding: 20px; border: 2px solid #2c3e50; border-radius: 15px; text-align: center; vertical-align: top;">
      <a href="clarks" target="_blank">
        <img src="https://raw.githubusercontent.com/dr-vishakha-gupta/portfolio/main/images/Clarks.png" alt="Clarks Project" style="
          width: 80%; 
          max-height: 150px; 
          object-fit: contain; 
          display: block;
    ...
    <td width="50%" style="padding: 20px; border: 2px solid #2c3e50; border-radius: 15px; text-align: center; vertical-align: top;">
      <a href="ekimetrics" target="_blank">
        <img src="https://raw.githubusercontent.com/dr-vishakha-gupta/portfolio/main/images/Ekimetrics.png" alt="Ekimetrics Project" style="
          width: 80%; 
          max-height: 150px; 
          object-fit: contain; 
          display: block;
